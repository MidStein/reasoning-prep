                ...
                items=[
                    ...
                    Input.Group(
                        ...
                        questions=[
                            ...
                            "If the team consists of two doctors, two female teachers and two engineeers, all the following teams are possible except :",
                    ...
                    Input.Group(
                        parent_question="Directions : Study the following information carefully and answer the question that follows :<br><br>At an Electronic Data Processin Unit, five out of the eight program sets P, Q, R, S, T, U, V and W are to be operated daily. On any one day, except for the first day of a month, only three of the program sets must be the ones that were operated on the previous day. The program operating must also satisfy the following conditions :<ol type='i'><li>If program P is to be operated on a day, V cannot be operated on that day.</li><li>If Q is to be operated on a day, T must be one of the progrms to be operated after Q.</li><li>If R is to be operated on a day, V must be one of the programs to be operated after R.</li><li>The last program to be operated on any day must be either S or U.</li></ol>",
                        questions=[
