    ...
    Input.Type(
        ...
        cases=[
            Input.Case(
                ...
                items=[
                    Input.Group(
                        parent_question="Directions : A number series is given with one term missing. Choose the correct alternative that will continue the same pattern and fill in the blank spaces.",
                        questions=[
                            "1, 4, 9, 16, 25, (.....)",
                            "20, 19, 17, (.....), 10, 5",
                            "2, 3, 5, 7, 11, (.....), 17",
                            ...
                            "In the series 10, 17, 24, 31, 38, ... which of the following will be a numberof the series ?",
            ...
            Input.Case(
                ...
                items=[
                    Input.Group(
                        parent_question="Directions : One term in the number series is wrong. Find out the wrong term.",
                        questions=[
                            "24, 27, 31, 33, 36",
                            "196, 169, 144, 121, 80",
                            "3, 5, 7, 9, 11, 13",
                    ...
                    Input.Group(
                        parent_question="Directions : In the following number series, either one term is missing or is wrong which has been given as one of the four alternatives under it. This alternative is your answer.",
                        questions=[
                            "1, 2, 5, 10, 17, 28",
                            "1, 5, 11, 19, 29, 55",
                            "2, 3, 5, 8, 13, 34",
    ...
    Input.Type(
        ...
        cases=[
            Input.Case(
                items=[
                    Input.Group(
                        parent_question="Directions : In each of the following question, various terms of a letter series are given with one term missing as shows by (?). Choose the missing term out of the given alternatives.",
                        questions=[
                            "U, O, I, ?, A",
                            "Y, W, U, S, Q, ?, ?",
                            "A, B, D, G, ?",
                    ...
                    Input.Group(
                        parent_question="Directions : In the followsing number series, a sequence of groups of letters and numbers is given with one term missing as shown by (?). Choose the missing term out of the given alternatives.",
                        questions=[
                            "D-4, F-6, H-8, J-10, ?, ?",
                            "3F, 6G, 11I, 18L, ?",
                            "KM5, IP8, GS11, EV14, ?",
    ...
    Input.Type(
        ...
        cases=[
            Input.Case(
                items=[
                    Input.Group(
                        parent_question="In the following letter series, some of the letters are missing which are given in that order as one of the alternatives below it. Choose the correct alternative.",
                        questions=[
                            "_ _ aba _ _ ba _ ab",
                            "ab _ _ _ b _ bbaa _",
                            "_ baa _ aab _ a _ a",
                    ...
                    Input.Group(
                        parent_question="In the following questions, three sequences of letters/numerals are given which correspond to each other other in some way. You have to find out the letters/numerals that come in the vacant places marked by (?). These are given as one of the four alternatives under the question. Mark your answer as instructed.",
                        questions=[
                            "<code>C B _ _ D _ B A B C C B<br>_ _ 1 2 4 3 _ _ ? ? ? ?<br>a _ a b _ c _ b _ _ _ _</code>",
                            "<code>_ A C _ B D _ C D C D<br>2 _ 4 1 _ 1 4 _ _ _ _<br>c d _ b c _ a ? ? ? ?</code>",
                            "<code>C _ B _ D _ A _ B B D D<br>2 _ _ 4 _ 3 4 _ ? ? ? ?<br>_ a _ c b a _ d _ _ _ _</code>",
                            "<code>A _ B A C _ D _ B C D C<br>_ 3 _ 2 _ 1 _ 4 ? ? ? ?<br>d c _ _ b a c b _ _ _ _</code>",
                            "<code>_ A D A C B _ _ B D C C<br>1 3 _ _ 1 2 4 2 _ _ _ _<br>a _ _ b _ _ c d ? ? ? ?</code>",
                        ],
                        from_question=56,
                    ),
                ]
